...
# Sample version of docker-entrypoint.sh with customisations as follows
# - Install trusted CA certificates from named directory <RCS BASE>/trusted-cas
# - Use ENV variables RCS_CLIENT_ID and RCS_CLIENT_SECRET for client id and secret
# - Use own hostname for RCS server name
